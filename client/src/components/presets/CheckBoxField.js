  ...
  return (
    <div className={guide && guide === '8' ? 'guide__checkboxfield_zindex' : undefined}>
      ...
      <span className='grid-2 my-1'>
        <label
          className={
            guide && guide === '6' ? 'presetformtypecheckboxcontainer guide__overheadtextcolor' : 'presetformtypecheckboxcontainer'
          }
        >
          Overhead
        ...
        <label
          className={guide && guide === '10' ? 'presetformtypecheckboxcontainer guide__checkbox__text' : 'presetformtypecheckboxcontainer'}
        >
          Purchase
        ...
        <label
          className={guide && guide === '9' ? 'presetformtypecheckboxcontainer guide__checkbox__text' : 'presetformtypecheckboxcontainer'}
        >
          Savings
        ...
        <label
          className={guide && guide === '8' ? 'presetformtypecheckboxcontainer guide__checkbox__text' : 'presetformtypecheckboxcontainer'}
        >
          Capital
